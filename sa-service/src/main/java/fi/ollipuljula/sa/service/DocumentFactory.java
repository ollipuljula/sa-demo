...
import fi.ollipuljula.sa.form.engine.*;
import fi.ollipuljula.sa.orm.entity.UserEntity;
import fi.ollipuljula.sa.service.bean.UserEntityCalculatedValues;
import fi.ollipuljula.sa.service.bean.UserEntityValidationRules;
...
public class DocumentFactory {
    ...
    public Document create(final UserEntity userEntity) {
        ...
        final BasicSection<UserEntity, String> basicSection = new BasicSection(firstNameField, lastNameField, ageField);
        ...
        final ContactSection contactSection = new ContactSection(emailField, phoneNumberField);
